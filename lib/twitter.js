...
var Twitter = function (oauth) {
  ...
  if (!oauth || !(oauth.consumer_secret || oauth.consumer_key || oauth.token || 
oauth.token_secret)) {
...
Twitter.prototype.twitterUrl = 
'https://stream.twitter.com/1.1/statuses/filter.json'

Twitter.prototype.timeoutInterval = 1000 * 90 // default twitter timeout is 90 
seconds
...
Twitter.prototype.connect = function () {
  ...
  this.stream.on('response', (function (res) {
    ...
    if (res.statusCode > 200) {
      ...
      this.emit('reconnect', {type: 'http', err: new Error('Twitter connection 
...
https://dev.twitter.com/docs/streaming-apis/connecting#Stalls
    // Abort the connection and reconnect if we haven't received an update for 
90 seconds
    var close = (function () {
        this.abort()
